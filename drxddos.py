...
bot = telebot.TeleBot('7861197632:AAEnRd7kepvvDRjaIFfc7hYkGOUeWQUNqu4')
...
def add_user(message):
    ...
    if user_id in admin_id:
        ...
        response = "Mood ni hai abhi pelhe purchase kar:- @Roxz_gaming."
...
def welcome_start(message):
    ...
    response = f'''🔥●ᴷᵃˡ ᶜʰᵒᵈᵉ ˢᵒ ᵃᵃʲ ᶜʰᵒᵈ ᵃᵃʲ ᶜʰᵒᵈᵉ ˢᵒ ᵃᵇ! ᴸᵃᵈᵏⁱ ᵗᵒ ᶜʰᵘᵈᵗⁱ ʳᵃʰᵉᵍⁱ ᴮᴳᴹᴵ ᴷᴬ ˢᴱᴿⱽᴱᴿ ᶜᴴᴼᴰᴱᴳᴬ ᴷᴬᴮ?🤣*\n\n"
